...
namespace SA.iOS.UserNotifications.Internal
{
    ...
    internal class ISN_UNNativeAPI : ISN_Singleton<ISN_UNNativeAPI>, ISN_iUNAPI
    {
        ...
        private event Action<ISN_UNNotificationSettings> m_onGetNotificationSettings;
        ...
        private Action<List<ISN_UNNotificationRequest>> m_onGetPendingNotificationRequests;
        ...
        private Action<List<ISN_UNNotification>> m_onGetDeliveredNotifications;
