...
#if (UNITY_IPHONE && !UNITY_EDITOR && SOCIAL_API_ENABLED)
...
namespace SA.iOS.Social
{
    ...
    public static class ISN_Media
    {

        public static event Action<SA_Result> OnShareResult = delegate { };

        public static void Share(string message, Action<SA_Result> callback = null) {
            Share(message, new Texture2D[] {}, callback);
        }

        public static void Share(Texture2D image, Action<SA_Result> callback = null) {
            Share(null, new Texture2D[] { image }, callback);
        }

        public static void Share(Texture2D[] images, Action<SA_Result> callback = null) {
            Share(null, images, callback);
        }

        public static void Share(string message, Texture2D image, Action<SA_Result> callback = null) {
