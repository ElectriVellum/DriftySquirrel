...
namespace SA.iOS.GameKit
{
    ...
    public class ISN_GKAchievement 
    {
        ...
        [SerializeField] float m_percentComplete;
        [SerializeField] long m_lastReportedDate;
        ...
        public DateTime LastReportedDate {
            get {
                return SA_Unix_Time.ToDateTime(m_lastReportedDate);
            }
        }
        ...
        public void Report(Action<SA_Result> callback) {
            List<ISN_GKAchievement> achievements = new List<ISN_GKAchievement>();
        ...
        public static void ResetAchievements(Action<SA_Result> callback) {
            ISN_GKLib.API.RsesetAchievements(callback);
        }
