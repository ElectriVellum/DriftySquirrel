...
namespace SA.iOS.GameKit
{
    ...
    public class ISN_GKScore 
    {
        ...
        [SerializeField] long m_context;
        [SerializeField] long m_date;

        [SerializeField] string m_formattedValue;
        [SerializeField] string m_leaderboardIdentifier;
        ...
        public void Report(Action<SA_Result> callback) {
            List<ISN_GKScore> scores = new List<ISN_GKScore>() { this};
