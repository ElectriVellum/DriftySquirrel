...
namespace SA.iOS
{
    ...
    public class ISN_Settings : SA_ScriptableSingleton<ISN_Settings>
    {
        ...
        //onlye here for compatibility with version 2018.3.2
        public static string VERSION_NUMBER = "2018.2.3_compatibility";
        ...
        public string CameraUsageDescription {
            get {
               return GetPlistKeyValue("NSCameraUsageDescription", "Please change 'Camera Usage Description' with IOS Native UI Kit Editor Settings");
            }

            set {
                SetPlistKeyValue("NSCameraUsageDescription", value);  
            }
        }

        public string PhotoLibraryUsageDescription {
            get {
                return GetPlistKeyValue("NSPhotoLibraryUsageDescription", "Please change 'Photo Library Usage Description' with IOS Native UI Kit Editor Settings");
            }

            set {
                SetPlistKeyValue("NSPhotoLibraryUsageDescription", value);
            }
        }
        ...
        public string PhotoLibraryAddUsageDescription {
            get {
                return GetPlistKeyValue("NSPhotoLibraryAddUsageDescription", "Please change 'Photo Library Add Usage Description' with IOS Native UI Kit Editor Settings");
            }

            set {
                SetPlistKeyValue("NSPhotoLibraryAddUsageDescription", value);
            }
        }
        ...
        public string MicrophoneUsageDescription {
            get {
                return GetPlistKeyValue("NSMicrophoneUsageDescription", "Please change 'Microphone Usage Description' with IOS Native UI Kit Editor Settings");
            }

            set {
                SetPlistKeyValue("NSMicrophoneUsageDescription", value);
            }
        }
        ...
        private void SetPlistKeyValue(string key, string val) {
            if(!val.Equals(GetPlistKeyValue(key, val))) {
