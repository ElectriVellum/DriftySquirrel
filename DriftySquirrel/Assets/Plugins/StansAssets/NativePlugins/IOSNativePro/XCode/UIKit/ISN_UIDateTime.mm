...
- (void)DP_changeDate:(UIDatePicker *)sender {
    ...
    ISN_SendMessage("SA.IOSNative.UIKit.ISN_UIDateTimeReceiver", "DateTimePickerDateChanged", dateString);
}
...
-(void) DP_PickerClosed:(UIDatePicker *)sender {
    ...
    NSString *dateString = [dateFormatter stringFromDate:sender.date];
     ...
     ISN_SendMessage("SA.IOSNative.UIKit.ISN_UIDateTimeReceiver", "DateTimePickerClosed", dateString);
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ISN_SendMessage("SA.IOSNative.UIKit.ISN_UIDateTimeReceiver", "CalendarPickerClosed", dateStr);
...
extern "C" {
    ...
    void _ISN_ShowDP(int mode) {
            #if !TARGET_OS_TV
         [[ISN_UIDateTime sharedInstance] DP_show:mode date:nil];
            #endif
    }
    ...
    void _ISN_ShowDPWithTime(int mode, double seconds) {
        ...
        [[ISN_UIDateTime sharedInstance] DP_show:mode date:date];
            #endif
    }
